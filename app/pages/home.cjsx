  ...
  home:
    ...
    about:
      contribute:
        ...
        content: '''Collaboratory te permite participar en proyectos reales e innovadores en múltiples campos pertenecientes a la ciencia, humanidades, y más. No es necesaria ninguna experiencia previa, simplemente elegí un proyecto y [empezá ahora mismo](/projects).'''
      explore:
        title: 'Explorá mundos increíbles'
        content: '''Maravillas de la astronomía, fauna silvestre en sus hábitats naturales, documentos históricos originales: éstas son sólo algunas de las cosas que podrás experimentar. En algunos casos, es posible que veas algo que nunca antes alguien haya visto'''
      collaborate:
        title: 'Colaborá con investigadores'
        content:'''Investigadores profesionales junto con voluntarios, comparten nuestros [espacios de discusión](/talk), usándolos para explorar y analizar datos del proyecto. Mucha de la investigación más interesante se origina a partir de estas colaboraciones.'''
      discover:
        title: 'Descubrí, enseñá y aprendé'
        content: '''Our platform offers many opportunities for education, from using projects in classrooms to sharing information between volunteers. You can even use the [Zooniverse Project Builder](/lab) to create your very own project!'''
    featuredProjects:
    ...
    recentProjects:
      title: "¡Bienvenido otra vez! Accedé a alguno de tus proyectos recientes..."
      altTitle: "¡Bienvenido! Accedé a alguno de los proyectos nuevos..."
      button: "Ver todos tus proyectos"
      altButton: "Ver todos los proyectos"
